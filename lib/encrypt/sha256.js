...
var HMAC_SHA256_key = undefined
var SHA256_H = undefined
var SHA256_buf = undefined
var SHA256_len = undefined
...
function HMAC_SHA256_MAC(msg, key) {
...
function encode(value, key) {
  return array_to_hex_string(
    key ?
      HMAC_SHA256_MAC(value, key) :
      SHA256_hash(value))
}

export const sha256 = { encode }
