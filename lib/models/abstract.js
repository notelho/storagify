export class Abstract {
    ...
    _translate(instance) {
        let
            ...
            base = {
                _setItem: (key, value) => native._setItem.call(instance, key, value),
                _getItem: key => native._getItem.call(instance, key),
                _removeItem: key => native._removeItem.call(instance, key),
                _clear: () => native._clear.call(instance)
            }
